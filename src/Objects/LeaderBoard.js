...
const leaderboard = (() => {
  ...
  const savedScore = async (name, score) => {
    ...
    fetch('https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/9jBjxKq3RZ4KnMXLQEdw/scores', {
      mode: 'cors',
      method: 'POST',
      headers: {
  ...
  const receivedScore = async () => {
    const Scores = await fetch('https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/9jBjxKq3RZ4KnMXLQEdw/scores', {
      mode: 'cors',
    });
    return Scores.json();
  };
